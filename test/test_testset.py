...
def test_train_test_split():
    train_file = Path('resources/output_test/train.jsonl')
    test_file = Path('resources/output_test/test.jsonl')
    train_chunks = pd.read_json('resources/train.jsonl', lines=True, chunksize=10)
...
if __name__ == '__main__':
    test_split_events_short()
    test_split_events_long()
